...
void gameLoop() {
  ...
  player1.x = constrain(mouseX - playerWidth / 2, 0, width - playerWidth);
  // player2.x = constrain(mouseX - playerWidth / 2, 0, width - playerWidth);
...
void mousePressed() {
  // When the screen is touched or mouse is clicked, fire a bullet
